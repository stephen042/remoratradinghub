        ...
        if (mysqli_num_rows($sql) > 0) {
            ...
            if ($data['2fa'] == 1) {
                ...
                if ($update) {
                    ...
                    echo "<script>window.location.href = 'auth/2fa.php' </script>";
                }
            } else {
                        ...
                        <div class="row justify-content-center">
                            <div class="col-md-8 col-lg-6">
                                <div class="text-center">
                                    ...
                                    ?>
                                    <form class="m-auto" method="POST" action="login.php">
                                        <div class="row g-1">
                                            <div class="col-12">
                                            ...
                                            <div class="col-6 text-end">
                                                <a href="auth/forgot-password.php" class="link-dark text-decoration-none"><small>Forgot password?</small></a>
                                            </div>
                                            <div class="d-grid">
